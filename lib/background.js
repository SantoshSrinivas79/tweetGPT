...
class ChatGPTClient {
    ...
    async generateTweet(props) {
        ...
        const systemMessage = `You are a ghostwriter for users tweets. Use locale "${props.locale}". Return only one tweet. Keep it human and in the same tone of the original tweet`;
        const systemMessage2 = "Exclude everything after the tweet. Exclude hashtags. Exclude emojis. Don't apologize. Don't provide translation. Don't provide notes. Exclude сalls to action. Keep it very short.";
        const systemMessage3 = "Don't sound patronizing or like a professor!";
